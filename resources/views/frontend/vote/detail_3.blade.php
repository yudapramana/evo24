    ...
    <div class="container m-auto mt-10 md:mt-18">
        @if (!session('finish_vote'))
            <form id="voteform" method="post" action="{{ route('home.vote.store3') }}" class="form-vote">
                ...
                <h3 class="text-center text-2xl font-extrabold font-serif  mb-4">Silakan Pilih Senat Independen Jurusan {{ strtoupper($jurusan) }} sesuai pilihanmu! </h3>
                <div class="flex flex-wrap justify-center">
                    ...
                    <div class="frame-number">
                        <h1 class="text-5xl m-auto">{{ $item->number }}</h1>
                            ...
                            <div class="rounded-large overflow-hidden shadow-lg bg-white">
                                <div class="kandidat-container @if ($jurusan == 'Manajemen dan Bisnis Digital S1') manajemen @endif @if ($jurusan == 'Akuntansi S1') akuntansi @endif @if ($jurusan == 'Ekonomi Islam S1') ekonomi-islam @endif @if ($jurusan == 'Ekonomi S1') ekonomi @endif">
                    ...
                    {{-- @if (count($candidates3) == 1)
                        <div class="py-2 px-2 w-full md:w-1/2">
                            <div class="rounded-large overflow-hidden shadow-lg bg-white">
                                <div class="kandidat-container @if ($jurusan == 'Manajemen dan Bisnis Digital S1') manajemen @endif @if ($jurusan == 'Akuntansi S1') akuntansi @endif @if ($jurusan == 'Ekonomi Islam S1') ekonomi-islam @endif @if ($jurusan == 'Ekonomi S1') ekonomi @endif">
                                    <p class="text-center pt-24 text-white px-6 text-2xl mx-auto" style="font-family: 'Courier New', Courier, monospace!important">Kotak Kosong</p>
                                </div>
                                <div class="object-center h-10 mt-8 flex">
                                    <img src="https://lpmhayamwuruk.org/wp-content/uploads/2021/11/index-1024x1024.jpg" class="kandidat-frame object-cover">
                                </div>
                                <div class="text-center pb-10 pt-10 flex flex-col">
                                    <button type="button" class="mx-auto btn-sm mt-8" onclick="vote(this)" data-name="{{ $item->name }}" data-identitas="{{ $item->id }}" data-sumref="#sumdata1">Vote</button>
