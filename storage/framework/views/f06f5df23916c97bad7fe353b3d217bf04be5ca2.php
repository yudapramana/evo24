                ...
                <div class="kt-widget14">
                    ...
                    <div class="kt-widget14__content">
                        <div class="flex mr-5">
                            ...
                            <h3>
                                <?php echo e($member_count - $voting_count); ?> (<?php echo e(sprintf('%.2f%%', (($member_count - $voting_count) / ($member_count ?: 1)) * 100)); ?>)
                            </h3>
                    ...
                    <div class="kt-widget14__content" style="margin-top:50px !important;">
                        ...
                        <?php $__currentLoopData = $member_count_3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex mr-5">
                                ...
                                <h3>
                                    <?php echo e($item - $votinCountsen); ?> (<?php echo e(sprintf('%.2f%%', (($item - $votinCountsen) / ($item ?: 1)) * 100)); ?>)
                                </h3>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\evote2024\resources\views/backend/home/index.blade.php ENDPATH**/ ?>