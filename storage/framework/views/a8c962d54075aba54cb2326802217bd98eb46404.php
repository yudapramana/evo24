<?php $__env->startSection('content'); ?>
    ...
    <div class="container m-auto mt-15 md:mt-18">
        ...
        <?php if(session('finish_vote')): ?>
            ...
            <div class="text-center text-4xl font-extrabold font-serif italic mt-10">
                <a href="<?php echo e(route('home.vote')); ?>" class="link-button <?php echo e(url()->current() == route('home.vote') || url()->current() == route('home.vote.detail') ? 'active' : ''); ?>">
                    Vote
                </a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.plain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\evote2024\resources\views/frontend/vote/detail.blade.php ENDPATH**/ ?>