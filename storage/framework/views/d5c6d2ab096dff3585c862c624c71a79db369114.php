<?php $__env->startSection('content'); ?>
    ...
    box-shadow: inset 0 0 0 1000px rgba(0,0,0,.7);">
        ...
        <h4 class="text-center text-white text-xl font-bold pt-2" style="text-transform: uppercase; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-weight:bolder;">
        ...
        <div class="mb-4 pb-4">
            ...
            <h2 class="text-center text-white text-md"><i class="fab fa fa-instagram mt-1"></i> <a href="https://instagram.com/pemirafebundip " target="_blank">@pemirafebundip </a>
            </h2>
            <h2 class="text-center text-white text-md"><i class="fab fa fa-envelope mt-1"></i> <a href="mailto:pemirafebundip.official@gmail.com " target="_blank">pemirafebundip.official@gmail.com </a>
            </h2>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\evote2024\resources\views/frontend/home/index.blade.php ENDPATH**/ ?>