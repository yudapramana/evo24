    ...
    <div class="container">
        ...
        <div class="flex flex-wrap justify-center">
            ...
            <div class="py-2 px-2 w-full md:w-1/2 mb-20">
                ...
                <div class="rounded-large overflow-hidden shadow-lg bg-white">
                    <div
                        class="kandidat-container <?php if($item->jurusan == 'Manajemen dan Bisnis Digital S1'): ?> manajemen <?php endif; ?> <?php if($item->jurusan == 'Akuntansi S1'): ?> akuntansi <?php endif; ?> <?php if($item->jurusan == 'Ekonomi Islam S1'): ?> ekonomi-islam <?php endif; ?> <?php if($item->jurusan == 'Ekonomi S1'): ?> ekonomi <?php endif; ?>">
                        <p class="text-center pt-24 text-white px-6 text-2xl mx-auto"><?php echo e($item->name); ?></p>
                    </div>
                    <div class="object-center h-10 mt-8 flex">
                        <img src="<?php echo e($item->image); ?>" class="kandidat-frame object-cover">
